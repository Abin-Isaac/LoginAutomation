...
//data testid
 ...
 Pwreset.click();
 WebElement emailForReset = driver.findElement (By.xpath("//input[@id='identify_email']"));
 emailForReset.sendKeys("asdf@gmail.com");
 WebElement buttonToCheckEmailForReset = driver.findElement (By.xpath("//button[@id='did_submit']"));
 buttonToCheckEmailForReset.click();
